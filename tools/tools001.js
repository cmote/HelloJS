...
gewa.util.maskContent = function(el,content,title,width,def,callback,bgcolor,dialogBgcolor,isEsc,cancelCallback,initCallback,isPin)
{
	//@comments start
	/*id,content,z-index* ///content可传id
...
{
	//@comments start
	/*id,content,width,flagId,z-index* /
